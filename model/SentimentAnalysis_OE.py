...
logging.basicConfig(filename="BILSTM.log", 
...
class SentimentRNN(nn.Module):
    ...
    def forward(self, x,hidden):
        ...
        return F.log_softmax(lstm_out),hidden
...
for e in range(epochs):
    ...
    logger.info('train_loss'+str(running_val_loss)+'at epoch'+str(e+1))
    torch.save({
    'epoch': e+1,
    ...
    }, 'entire_model_onlyBiLSTM'+str(e+1)+'.pt')
...
for inputs in test_loader:
    ...
    with open('output_onlyBiLSTM.txt','a+',encoding ="utf-8") as fp:
...
PATH = "entire_model_onlyBiLSTM.pt"
